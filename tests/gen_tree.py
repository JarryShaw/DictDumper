...
dumper_0 = dictdumper.Tree(os.path.join(ROOT, 'tree', 'test_0.txt'))
...
dumper_1 = dictdumper.Tree(os.path.join(ROOT, 'tree', 'test_1.txt'))
...
dumper_2 = dictdumper.Tree(os.path.join(ROOT, 'tree', 'test_2.txt'))
...
dumper_3 = dictdumper.Tree(os.path.join(ROOT, 'tree', 'test_3.txt'))
