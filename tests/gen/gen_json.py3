...
dumper_0 = dictdumper.Tree(os.path.join(ROOT, '..', 'json', 'test_0.json'))
...
dumper_1 = dictdumper.Tree(os.path.join(ROOT, 'json', 'test_1.json'))
...
dumper_2 = dictdumper.Tree(os.path.join(ROOT, 'json', 'test_2.json'))
...
dumper_3 = dictdumper.Tree(os.path.join(ROOT, 'json', 'test_3.json'))
