...
dumper_0 = dictdumper.Tree(os.path.join(ROOT, '..', 'plist', 'test_0.plist'))
...
dumper_1 = dictdumper.Tree(os.path.join(ROOT, 'plist', 'test_1.plist'))
...
dumper_2 = dictdumper.Tree(os.path.join(ROOT, 'plist', 'test_2.plist'))
...
dumper_3 = dictdumper.Tree(os.path.join(ROOT, 'plist', 'test_3.plist'))
